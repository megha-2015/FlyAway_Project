...
<title>Delete Flight Check</title>
...
<div>
 <center>
  ...
  <br><br>
  <h1 style="color:navy;">Confirmation Page for Deletion of Flight</h1> 
  <hr width="70%"><br>
  		...
  		<c:choose>
   		...
   		<br>
   			<p style="font-size:25px;">Please Enter the flight number to delete.</p>
   			<a style="font-size:25px;" href="DeleteFlight.jsp?a_email=<%= request.getParameter("a_email")%>">Back</a>
