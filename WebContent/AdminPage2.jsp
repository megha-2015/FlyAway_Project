...
<c:set var="a_email1" value="<%=email%>"/>

	<c:choose>
  		<c:when test = "${empty a_email1}">
  			<h1>Please Enter a Valid Email Id/Password</h1>
  			<c:out value="${a_email1}"></c:out>
  		</c:when>
  		<c:otherwise>
  			<label style="float:left;margin-left:15px;font-size:20px;text-decoration: underline;">Welcome Admin:<c:out value="${a_email1}"></c:out></label> 	
  			...
  			<div align="left">
  				...
  				<p style="font-size:20px;margin-left:30px;">1.&nbsp;<a href="InsertFlight.jsp?a_email=${a_email1}">Add a New Flight</a></p>
  				<p style="font-size:20px;margin-left:30px;">2.&nbsp;<a href="DeleteFlight.jsp?a_email=${a_email1}">Delete a Flight</a></p>
  				<p style="font-size:20px;margin-left:30px;">3.&nbsp;<a href="UpdateFlight.jsp?a_email=${a_email1}">Update a Flight</a></p>
  			</div>
		</c:otherwise>
	</c:choose>	
</div>
